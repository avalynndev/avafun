      ...
      >
        ...
        <div className="space-y-8">
          <section>
            ...
            <p>
              Welcome to Avafun! This Privacy Policy explains how we collect,
              use, and protect your information when you use our web-based
              arcade game platform. Avafun is designed to be a fun, interactive
          ...
          <section>
            ...
            <p className="mb-4">
              Avafun uses your browser&apos;s local storage to enhance your
              gaming experience:
            </p>
          ...
          <section>
            ...
            <p>
              If you have any questions about this Privacy Policy or Avafun,
              please contact us:
            </p>
        ...
        <div className="mt-12 p-6 bg-muted rounded-lg">
          ...
          <p className="text-muted-foreground">
            Thank you for playing Avafun! We&apos;re committed to providing a
